...
model_urls = {
    'inception_v4': 'https://s3.amazonaws.com/pytorch/models/inceptionv4-58153ba9.pth'
}
...
def inception_v4(num_classes=True, **kwargs):
    ...
    #     state_dict = torch.load('/data/pretrained_ckpt/inception_v4.pth')
    #     model_dict = model.state_dict()
    #     state_dict = {k: v for k, v in state_dict.items() if k in model_dict and "classif" not in k}
