...
adjust_fr = 200
sgd_switch = True
save_filename = './ckpt/mobileNet.pth.tar'
...
# parser.add_argument('--resume', default='./ckpt/mobileNet.pth.tar', type=str, metavar='path',
#                     help='path to latest checkpoint')
parser.add_argument('--resume', default=save_filename, type=str, metavar='path',
                    help='path to latest checkpoint')
parser.add_argument('--log', default='log/mobileNet2', type=str, metavar='logpath',
...
def main():
    ...
    model = mobileNet_V2(num_classes=2).cuda()
    ...
    if args.pretrained:
        ...
        print('using the pretrained mobilenetv2 model')
